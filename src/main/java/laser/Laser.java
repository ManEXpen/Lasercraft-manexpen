...
public class Laser {
	...
	public static CreativeTabs tabItems = (new CreativeTabItems())
			.func_111229_a(new EnumEnchantmentType[] { enchantmentTypeLC });

	@EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		config.setConfiguration(
				new Configuration(new File(event.getModConfigurationDirectory(), "cofh/LaserCraft.cfg")));
		this.cleanConfig(true);
		this.configure();
		fluidGhast = (new Fluid("ghast")).setLuminosity(7).setDensity(1500).setViscosity(1000).setTemperature(350)
		...
		EntityRegistry.registerGlobalEntityID(EntityUTNTPrimed.class, "UTNTPrimed",
	...
	public void postInit(FMLPostInitializationEvent event) {
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(ItemHelper.cloneStack(TFItems.dustMana, 2),
				new Object[] { "dustObsidian", "crystalCinnabar", "dustRedstone", "dustMithril" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(ItemHelper.cloneStack(dustBrass, 4),
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(dustSteel,
				new Object[] { "dustCharcoal", "dustCharcoal", "dustCharcoal", "dustCharcoal", "dustIron" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(ItemHelper.cloneStack(dustStainlessSteel, 6),
				new Object[] { "dustIron", "dustIron", "dustIron", "dustIron", "dustNickel", "dustChromium" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(ItemHelper.cloneStack(dustGhastly, 2), new Object[] {
				"dustStainlessSteel", "dustStainlessSteel", "dustStainlessSteel", crystalGhast, TFItems.bucketMana }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(ItemHelper.cloneStack(dustUnobtainium, 2),
				new Object[] { "dustTitanium", "dustTitanium", "dustTungsten", "dustTungsten", TFItems.bucketCoal }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(ItemHelper.cloneStack(dustBediron, 2),
				new Object[] { "dustBedrock", "dustIron" }));
		GameRegistry
				.addRecipe(new ShapedOreRecipe(frameSteel, new Object[] { "SGS", "GAG", "SGS", Character.valueOf('A'),
						"gearAluminium", Character.valueOf('S'), "ingotSteel", Character.valueOf('G'), "blockGlass" }));
		GameRegistry.addRecipe(new ShapedOreRecipe(ItemHelper.cloneStack(casingSteel, 6), new Object[] { "III", "IGI",
				"III", Character.valueOf('I'), "ingotSteel", Character.valueOf('G'), "gearSteel" }));
		GameRegistry.addRecipe(new ShapedOreRecipe(machineAlloySmelter,
				new Object[] { "BBB", "BFB", "ZGZ", Character.valueOf('B'), new ItemStack(Blocks.stonebrick),
						Character.valueOf('F'), frameSteel, Character.valueOf('Z'), "gearZinc", Character.valueOf('G'),
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(machineGrinder,
				new Object[] { "BBB", "PCP", "SGS", Character.valueOf('B'), "bladeSteel", Character.valueOf('P'),
						Blocks.piston, Character.valueOf('C'), casingSteel, Character.valueOf('S'),
						"gearStainlessSteel", Character.valueOf('G'), TEItems.powerCoilGold }));
		GameRegistry.addRecipe(new ShapedOreRecipe(laserOscillator,
				new Object[] { "RHM", "BGB", Character.valueOf('R'), "lensRuby", Character.valueOf('H'), halfMirror,
						Character.valueOf('M'), mirror, Character.valueOf('B'), "gearBrass", Character.valueOf('G'),
						Blocks.glowstone }));
		GameRegistry.addRecipe(new ShapedOreRecipe(pulseLaserOscillator,
				new Object[] { "SHM", "BGB", Character.valueOf('S'), "lensSapphire", Character.valueOf('H'), halfMirror,
						Character.valueOf('M'), mirror, Character.valueOf('B'), "gearBrass", Character.valueOf('G'),
						Blocks.glowstone }));
		GameRegistry.addRecipe(new ShapedOreRecipe(dynamicLaserOscillator,
				new Object[] { "IHM", "SGS", Character.valueOf('I'), "gemInfused", Character.valueOf('H'), halfMirror,
						Character.valueOf('M'), mirror, Character.valueOf('S'), "gearSteel", Character.valueOf('G'),
						Blocks.glowstone }));
		GameRegistry.addRecipe(new ShapedOreRecipe(bladeSteel, new Object[] { "I I", " G ", "I I",
				Character.valueOf('I'), "ingotSteel", Character.valueOf('G'), "gearSteel" }));
		GameRegistry.addRecipe(new ShapedOreRecipe(chunkReader,
				new Object[] { " R ", "IDI", " G ", Character.valueOf('R'), "dustRedstone", Character.valueOf('I'),
						"ingotIron", Character.valueOf('G'), "gearIron", Character.valueOf('D'),
						new ItemStack(Blocks.dirt) }));
		GameRegistry.addRecipe(new ShapedOreRecipe(chunkRecorder,
				new Object[] { " S ", "GCG", " S ", Character.valueOf('S'), TEItems.powerCoilSilver,
						Character.valueOf('C'), chunkReader, Character.valueOf('G'), "gearBrass" }));
		GameRegistry.addRecipe(new ShapedOreRecipe(normalRockcutter,
				new Object[] { "BT ", "TGT", " TC", Character.valueOf('B'), "bladeSteel", Character.valueOf('T'),
						"ingotTitanium", Character.valueOf('G'), "gearTitanium", Character.valueOf('C'),
						TEItems.capacitorHardened }));
		GameRegistry.addRecipe(new ShapedOreRecipe(laserRockcutter,
				new Object[] { "LT ", "TGT", " TC", Character.valueOf('L'), dynamicLaserOscillator,
						Character.valueOf('T'), "ingotTitanium", Character.valueOf('G'), "gearChromium",
						Character.valueOf('C'), TEItems.capacitorHardened }));
		GameRegistry.addRecipe(new ShapedOreRecipe(swordBediron, new Object[] { "I", "I", "G", Character.valueOf('I'),
				"ingotBediron", Character.valueOf('G'), "gearBediron" }));
		...
		SmelterManager.addAlloyRecipe(8000, new ItemStack(Items.ghast_tear), ItemHelper.cloneStack(dustInfused, 2),
				crystalGhast);
		...
		TransposerManager.addFillRecipe(8000, new ItemStack(Blocks.tnt), underwaterTNT,
				new FluidStack(TFFluids.fluidPyrotheum, 250), false);
		AlloySmelterManager.addOreDictionaryRecipe(800, ItemHelper.cloneStack(ingotStainlessSteel, 6),
				new Object[] { "dustIron", Integer.valueOf(4), "dustNickel", "dustChromium" });
		AlloySmelterManager.addOreDictionaryRecipe(1200, ItemHelper.cloneStack(ingotStainlessSteel, 6),
				new Object[] { "ingotIron", Integer.valueOf(4), "ingotNickel", "ingotChromium" });
		AlloySmelterManager.addOreDictionaryRecipe(8000, glassReinforced,
				new Object[] { "blockGlassHardened", "dustObsidian", Integer.valueOf(4), "dustElectrum" });
		AlloySmelterManager.addOreDictionaryRecipe(8000, glassResonant,
				new Object[] { "blockGlassReinforced", "dustObsidian", Integer.valueOf(4), "dustEnderium" });
		AlloySmelterManager.addOreDictionaryRecipe(8000, mirror,
				new Object[] { "blockGlassColorless", "dustSilver", Integer.valueOf(4) });
		AlloySmelterManager.addOreDictionaryRecipe(8000, halfMirror,
				new Object[] { "blockGlassColorless", "dustAluminium", Integer.valueOf(2) });
		AlloySmelterManager.addOreDictionaryRecipe(8000, halfMirror,
				new Object[] { "blockGlassColorless", "dustAluminum", Integer.valueOf(2) });
		AlloySmelterManager.addOreDictionaryRecipe(8000, glassLightShielding,
				new Object[] { "blockGlassResonant", "dyeBlack", Integer.valueOf(4) });
		AlloySmelterManager.addOreDictionaryRecipe(16000, gemInfused, new Object[] { "gemDiamond", "dustInfused",
				Integer.valueOf(2), ItemHelper.cloneStack(TFItems.dustPyrotheum, 2) });
		...
		AlloySmelterManager.addOreDictionaryRecipe(4000, ingotGoogle,
				new Object[] { "ingotChromium", "dyeRed", "dyeGreen", "dyeYellow", "dyeBlue" });
		GrinderManager.addRecipe(16000, new ItemStack(Blocks.bedrock),
				new ItemStack[] { ItemHelper.cloneStack(dustBedrock, 2) });
	}
	...
	private void cleanConfig(boolean paramBoolean) {
		...
		String[] arrayOfString = (String[]) ((String[]) config.getCategoryNames()
				.toArray(new String[config.getCategoryNames().size()]));
