...
public abstract class TileLargeMachineBase extends TileRSControl implements IReconfigurableFacing, ISidedTexture, IEnergyInfo {
      ...
      if(!ServerHelper.isClientWorld(this.worldObj)) {
         ...
         if(this.timeCheckEighth() && this.isComplete()) {
            ...
            while(i$.hasNext()) {
               ...
               TileCasing localTileCasing = (TileCasing)this.worldObj.getTileEntity(coord[0].intValue(), coord[1].intValue(), coord[2].intValue());
   ...
   public IIcon getTexture(int paramInt1, int paramInt2) {
      return paramInt1 != this.facing?IconRegistry.getIcon("CasingSteel_15"):(this.isActive?IconRegistry.getIcon("LCLargeMachineActive", this.getType()):IconRegistry.getIcon("LCLargeMachineFace", this.getType()));
   }
